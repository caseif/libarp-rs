...
pub(crate) const ENTRY_TYPE_RESOURCE: u8 = 0;
pub(crate) const ENTRY_TYPE_DIRECTORY: u8 = 1;
...
pub(crate) const PACK_HEADER_CAT_CNT_LEN: usize = 4;
...
pub(crate) const PACK_HEADER_CAT_CNT_OFF: usize = 0x4E;
...
pub(crate) const PACK_HEADER_CAT_CNT_END_OFF: usize =
    PACK_HEADER_CAT_CNT_OFF + PACK_HEADER_CAT_CNT_LEN;
...
pub(crate) const PART_INDEX_LEN: u64 = 2;
pub(crate) const PART_UNUSED_LEN: u64 = 6;

pub(crate) const PART_MAGIC_OFF: u64 = 0;
pub(crate) const PART_INDEX_OFF: u64 = 8;
pub(crate) const PART_UNUSED_OFF: u64 = 10;

// node structure constants
pub(crate) const ND_LEN_LEN: u64 = 2;
pub(crate) const ND_TYPE_LEN: u64 = 1;
pub(crate) const ND_PART_LEN: u64 = 2;
pub(crate) const ND_DATA_OFF_LEN: u64 = 8;
pub(crate) const ND_PACKED_DATA_LEN_LEN: u64 = 8;
pub(crate) const ND_UNPACKED_DATA_LEN_LEN: u64 = 8;
pub(crate) const ND_CRC_LEN: u64 = 4;
pub(crate) const ND_NAME_LEN_LEN: u64 = 1;
pub(crate) const ND_EXT_LEN_LEN: u64 = 1;
pub(crate) const ND_MT_LEN_LEN: u64 = 1;

pub(crate) const ND_LEN_OFF: u64 = 0x00;
pub(crate) const ND_TYPE_OFF: u64 = 0x02;
pub(crate) const ND_PART_OFF: u64 = 0x03;
pub(crate) const ND_DATA_OFF_OFF: u64 = 0x05;
pub(crate) const ND_PACKED_DATA_LEN_OFF: u64 = 0x0D;
pub(crate) const ND_UNPACKED_DATA_LEN_OFF: u64 = 0x15;
pub(crate) const ND_CRC_OFF: u64 = 0x1D;
pub(crate) const ND_NAME_LEN_OFF: u64 = 0x21;
pub(crate) const ND_EXT_LEN_OFF: u64 = 0x22;
pub(crate) const ND_MT_LEN_OFF: u64 = 0x23;
pub(crate) const ND_NAME_OFF: u64 = 0x24;

pub(crate) const NODE_DESC_BASE_LEN: u64 = ND_NAME_OFF;

pub(crate) const NODE_NAME_MAX_LEN: u64 = 0xFF;
pub(crate) const NODE_EXT_MAX_LEN: u64 = 0xFF;
pub(crate) const NODE_MT_MAX_LEN: u64 = 0xFF;
pub(crate) const NODE_DESC_MAX_LEN: u64 =
...
pub(crate) const NODE_DESC_INDEX_LEN: u64 = 4;
...
pub(crate) const DIRECTORY_CONTENT_MAX_LEN: u64 = 4294967296 * NODE_DESC_INDEX_LEN;
